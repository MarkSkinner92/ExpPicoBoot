...
#define PICOBOOT3_BOOTSEL3_PIN 16
...
// #define PICOBOOT3_UART_TX_PIN 0 // External UART
// #define PICOBOOT3_UART_RX_PIN 1 

#define PICOBOOT3_UART_INST uart1
#define PICOBOOT3_UART_TX_PIN 20 // Internal UART
#define PICOBOOT3_UART_RX_PIN 21
